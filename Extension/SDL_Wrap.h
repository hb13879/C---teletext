...
#define FNTWIDTH (sizeof(fntrow)*10)
#define FNTHEIGHT 18
#define FNTCHARS 96
...
void Neill_SDL_DrawChar(SDL_Simplewin *sw, fntrow fontdata[FNTCHARS][FNTHEIGHT], unsigned char chr, int ox, int oy,colour* rgbf, colour* rgbb,heightmd md);
